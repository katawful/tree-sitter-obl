...
struct Scanner {
  ...
  set<string> function_set = {
    ...
    "resetfalldamagetimer", "resethealth", "resetinterior", "resolvemodindex", "resurrect", "rightshift", "rotate", "rotmat", "rowvec",
    "rsin", "rsinh", "rtan", "rtanh", "runbatchscript", "runscriptline", "saa", "samefaction", "samefactionaspc", "samerace", "sameraceaspc",
    "samesex", "samesexaspc", "say", "sayto", "scaonactor", "scripteffectelapsedseconds", "selectplayerspell", "sendtrespassalarm",
