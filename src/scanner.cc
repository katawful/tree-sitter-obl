...
struct Scanner {
  ...
  set<string> function_set = {
    ...
    "con_refreshini", "con_runmemorypass", "con_save", "con_saveini", "con_setcamerafov", "setcamerafov2", "con_setclipdist", "con_setfog",
    "con_setgamesetting", "con_setgamma", "con_sethdrparam", "con_setimagespaceglow", "con_setinisetting", "con_setskyparam",
    "con_settargetrefraction", "con_settargetrefractionfire", "con_sexchange", "con_tcl", "con_tfc", "con_tgm", "con_toggleai", "con_togglecombatai",
    "con_toggledetection", "con_togglemapmarkers", "con_togglemenus", "con_waterdeepcolor", "con_waterreflectioncolor", "con_watershallowcolor",
    "copyalleffectitems", "copyeyes", "copyfemalebipedpath", "copyfemalegroundpath", "copyfemaleiconpath", "copyhair", "copyiconpath", "copyir",
    "copymalebipedpath", "copymalegroundpath", "copymaleiconpath", "copymodelpath", "copyname", "copyntheffectitem", "cos", "cosh",
    "createfullactorcopy", "createtempref", "creaturehasnohead", "creaturehasnoleftarm", "creaturehasnomovement", "creaturehasnorightarm",
    "creaturenocombatinwater", "creatureusesweaponandshield", "dacos", "dasin", "datan", "datan2", "dcos", "dcosh", "debugprint",
    "deletefrominputtext", "deletefullactorcopy", "deletereference", "disable", "disablecontrol", "disablekey", "disablelinkedpathpoints",
    "disablemouse", "disableplayercontrols", "dispatchevent", "dispel", "dispelallspells", "dispelnthactiveeffect", "dispelnthae", "drop", "dropme",
    "dsin", "dsinh", "dtan", "dtanh", "duplicateallitems", "duplicatenpcstats", "enable", "enablecontrol", "enablefasttravel", "enablekey",
    "enablelinkedpathpoints", "enablemouse", "enableplayercontrols", "equipitem", "equipitem2", "equipitem2ns", "equipitemns", "equipitemsilent",
    "equipme", "essentialdeathreload", "eval", "evaluatepackage", "eventhandlerexist", "evp", "exp", "factionhasspecialcombat", "fileexists", "floor",
    "fmod", "forceactorvalue", "forceav", "forcecloseobliviongate", "forcecolumnvector", "forceflee", "forcerowvector", "forcetakecover",
    "forceweather", "generateidentitymatrix", "generaterotationmatrix", "generatezeromatrix", "getactionref", "getactiveeffectcasters",
    "getactiveeffectcodes", "getactiveeffectcount", "getactivemenucomponentid", "getactivemenufilter", "getactivemenumode", "getactivemenuobject",
    "getactivemenuref", "getactivemenuselection", "getactivequest", "getactiveuicomponentfullname", "getactiveuicomponentid",
    "getactiveuicomponentname", "getactoralpha", "getactorbaselevel", "getactorlightamount", "getactormaxlevel", "getactorminlevel",
    "getactorpackages", "getactorsoullevel", "getactorvalue", "getactorvaluec", "getalarmed", "getalchmenuapparatus", "getalchmenuingredient",
    "getalchmenuingredientcount", "getallies", "getallmodlocaldata", "getaltcontrol2", "getamountsoldstolen", "getangle", "getapbowench", "getapench",
    "getapparatustype", "getappoison", "getarmorar", "getarmorrating", "getarmorratingupperbody", "getarmortype", "getarrayvariable",
    "getarrowprojectilebowenchantment", "getarrowprojectileenchantment", "getarrowprojectilepoison", "getattackdamage", "getattacked",
    "getavskillmastery", "getavskillmasteryc", "getfactions", "getbarteritem", "getbarteritemquantity", "getbaseactorvalue", "getbaseactorvaluec",
    "getbaseav", "getbaseav2", "getbaseav2c", "getbaseav3", "getbaseav3c", "getbaseitems", "getbaseobject", "getbipediconpath", "getbipedmodelpath",
    "getbipedslotmask", "getbirthsignspells", "getbookcantbetaken", "getbookisscroll", "getbooklength", "getbookskilltaught", "getbooktext",
    "getboundingbox", "getboundingradius", "getbuttonpressed", "getcalcalllevels", "getcalceachincount", "getcallingscript",
    "getcellbehavesasexterior", "getcellchanged", "getcellclimate", "getcelldetachtime", "getcellfactionrank", "getcelllighting", "getcellmusictype",
    "getcellnorthrotation", "getcellresethours", "getcellwatertype", "getchancenone", "getclass", "getclassattribute", "getclassdefaultmatch",
    "getclassmenuhighlightedclass", "getclassmenuselectedclass", "getclassskill", "getclassskills", "getclassspecialization", "getclimatehasmasser",
    "getclimatehassecunda", "getclimatemoonphaselength", "getclimatesunrisebegin", "getclimatesunriseend", "getclimatesunsetbegin",
    "getclimatesunsetend", "getclimatevolatility", "getclosesound", "getclothingvalue", "getcloudspeedlower", "getcloudspeedupper", "getcombatspells",
    "getcombatstyle", "getcombatstyleacrobaticsdodgechance", "getcombatstyleattackchance", "getcombatstyleattackduringblockmult",
    "getcombatstyleattacknotunderattackmult", "getcombatstyleattackskillmodbase", "getcombatstyleattackskillmodmult",
    "getcombatstyleattackunderattackmult", "getcombatstyleblockchance", "getcombatstyleblocknotunderattackmult", "getcombatstyleblockskillmodbase",
    "getcombatstyleblockskillmodmult", "getcombatstyleblockunderattackmult", "getcombatstylebuffstandoffdist",
