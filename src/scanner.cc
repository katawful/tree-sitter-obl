...
struct Scanner {
  ...
  set<string> function_set = {
    ...
    "ar_haskey", "ar_insert", "ar_insertrange", "ar_keys", "ar_last", "ar_list", "ar_map", "ar_next", "ar_null", "ar_prev", "ar_range", "ar_resize",
    "ar_size", "ar_sort", "ar_sortalpha", "asciitochar", "asin", "atan", "atan2", "autosave", "avstring", "calcleveleditem", "calclevitemnr",
    "calclevitems", "cancastpower", "cancorpsecheck", "canfasttravelfromworld", "canhaveflames", "canpaycrimegold", "cantraveltomapmarker", "cast",
    "ceil", "chartoascii", "clearactivequest", "clearhotkey", "clearleveledlist", "clearownership", "clearownershipt", "clearplayerslastriddenhorse",
    "clickmenubutton", "cloneform", "closeallmenus", "closecurrentobliviongate", "closeobliviongate", "closetextinput", "colvec",
    "comparefemalebipedpath", "comparefemalegroundpath", "comparefemaleiconpath", "compareiconpath", "comparemalebipedpath", "comparemalegroundpath",
    "comparemaleiconpath", "comparemodelpath", "comparename", "comparenames", "comparescripts", "completequest", "con_cal", "con_getinisetting",
    "con_hairtint", "con_loadgame", "con_modwatershader", "con_playerspellbook", "con_quitgame", "con_refreshini", "con_runmemorypass", "con_save",
    "con_saveini", "con_setcamerafov", "con_setclipdist", "con_setfog", "con_setgamesetting", "con_setgamma", "con_sethdrparam",
    "con_setimagespaceglow", "con_setinisetting", "con_setskyparam", "con_settargetrefraction", "con_settargetrefractionfire", "con_sexchange",
    "con_tcl", "con_tfc", "con_tgm", "con_toggleai", "con_togglecombatai", "con_toggledetection", "con_togglemapmarkers", "con_togglemenus",
    "con_waterdeepcolor", "con_waterreflectioncolor", "con_watershallowcolor", "copyalleffectitems", "copyeyes", "copyfemalebipedpath",
    "copyfemalegroundpath", "copyfemaleiconpath", "copyhair", "copyiconpath", "copyir", "copymalebipedpath", "copymalegroundpath", "copymaleiconpath",
    "copymodelpath", "copyname", "copyntheffectitem", "cos", "cosh", "createfullactorcopy", "createtempref", "creaturehasnohead",
    "creaturehasnoleftarm", "creaturehasnomovement", "creaturehasnorightarm", "creaturenocombatinwater", "creatureusesweaponandshield", "dacos",
    "dasin", "datan", "datan2", "dcos", "dcosh", "debugprint", "deletefrominputtext", "deletefullactorcopy", "deletereference", "disable",
    "disablecontrol", "disablekey", "disablelinkedpathpoints", "disablemouse", "disableplayercontrols", "dispatchevent", "dispel", "dispelallspells",
    "dispelnthactiveeffect", "dispelnthae", "drop", "dropme", "dsin", "dsinh", "dtan", "dtanh", "duplicateallitems", "duplicatenpcstats", "enable",
    "enablecontrol", "enablefasttravel", "enablekey", "enablelinkedpathpoints", "enablemouse", "enableplayercontrols", "equipitem", "equipitem2",
    "equipitem2ns", "equipitemns", "equipitemsilent", "equipme", "essentialdeathreload", "evaluatepackage",	"eventhandlerexist", "evp", "exp",
    "factionhasspecialcombat", "fileexists", "floor", "fmod", "forceactorvalue", "forceav", "forcecloseobliviongate", "forcecolumnvector",
    "forceflee", "forcerowvector", "forcetakecover", "forceweather", "generateidentitymatrix", "generaterotationmatrix", "generatezeromatrix",
    "getactionref", "getactiveeffectcasters", "getactiveeffectcodes", "getactiveeffectcount", "getactivemenucomponentid", "getactivemenufilter",
    "getactivemenumode", "getactivemenuobject", "getactivemenuref", "getactivemenuselection", "getactivequest", "getactiveuicomponentfullname",
    "getactiveuicomponentid", "getactiveuicomponentname", "getactoralpha", "getactorbaselevel", "getactorlightamount", "getactormaxlevel",
    "getactorminlevel", "getactorpackages", "getactorsoullevel", "getactorvalue", "getactorvaluec", "getalarmed", "getalchmenuapparatus",
    "getalchmenuingredient", "getalchmenuingredientcount", "getallies", "getallmodlocaldata", "getaltcontrol2", "getamountsoldstolen", "getangle",
    "getapbowench", "getapench", "getapparatustype", "getappoison", "getarmorar", "getarmorrating", "getarmorratingupperbody", "getarmortype",
    "getarrayvariable", "getarrowprojectilebowenchantment", "getarrowprojectileenchantment", "getarrowprojectilepoison", "getattackdamage",
    "getattacked", "getav", "getavc", "getavforbaseactor", "getavforbaseactorc", "getavmod", "getavmodc", "getbartergold", "getbarteritem",
    "getbarteritemquantity", "getbaseactorvalue", "getbaseactorvaluec", "getbaseav", "getbaseav2", "getbaseav2c", "getbaseav3", "getbaseav3c",
    "getbaseitems", "getbaseobject", "getbipediconpath", "getbipedmodelpath", "getbipedslotmask", "getbirthsignspells", "getbookcantbetaken",
    "getbookisscroll", "getbooklength", "getbookskilltaught", "getbooktext", "getboundingbox", "getboundingradius", "getbuttonpressed",
    "getcalcalllevels", "getcalceachincount", "getcallingscript", "getcellbehavesasexterior", "getcellchanged", "getcellclimate", "getcelldetachtime",
    "getcellfactionrank", "getcelllighting", "getcellmusictype", "getcellnorthrotation", "getcellresethours", "getcellwatertype", "getchancenone",
    "getclass", "getclassattribute", "getclassdefaultmatch", "getclassmenuhighlightedclass", "getclassmenuselectedclass", "getclassskill",
    "getclassskills", "getclassspecialization", "getclimatehasmasser", "getclimatehassecunda", "getclimatemoonphaselength", "getclimatesunrisebegin",
    "getclimatesunriseend", "getclimatesunsetbegin", "getclimatesunsetend", "getclimatevolatility", "getclosesound", "getclothingvalue",
    "getcloudspeedlower", "getcloudspeedupper", "getcombatspells", "getcombatstyle", "getcombatstyleacrobaticsdodgechance",
    ...
    "getweight", "getwindspeed", "getworldparentworld", "getworldspaceparentworldspace", "globalvariableexists", "goto", "gotojail", "hammerkey",
    ...
    "isquestcompleted", "isquestitem", "isracebonusskill", "isracebonusskillc", "israceplayable", "israining", "isrecoiling", "isrefdeleted",
    ...
    "isunsaferespawns", "isuppercase", "iswaiting", "isweapon", "isweaponout", "isxbox", "isyielding", "kill", "killactor", "killallactors", "label",
    ...
    "resetfalldamagetimer", "resethealth", "resetinterior", "resolvemodindex", "restoreip", "resurrect", "rightshift", "rotate", "rotmat", "rowvec",
    "rsin", "rsinh", "rtan", "rtanh", "runbatchscript", "runscriptline", "saa", "samefaction", "samefactionaspc", "samerace", "sameraceaspc",
    "samesex", "samesexaspc", "saveip", "say", "sayto", "scaonactor", "scripteffectelapsedseconds", "selectplayerspell", "sendtrespassalarm",
    "setactivequest", "setactoralpha", "setactorfullname", "setactorrefraction", "setactorrespawns", "setactorsai", "setactorvalue", "setactorvaluec",
    "setalert", "setallreachable", "setallvisible", "setaltcontrol2", "setangle", "setapparatustype", "setarmorar", "setarmortype",
    ...
    "setfemaleiconpath", "setfogdayfar", "setfogdaynear", "setfognightfar", "setfognightnear", "setforcerun", "setforcesneak", "setgamedifficulty",
    "setghost", "setgoldvalue", "setgoldvalue_t", "setgoldvaluet", "sethair", "setharvested", "sethasbeenpickedup", "sethdrvalue", "sethidesamulet",
    "sethidesrings", "sethotkeyitem", "seticonpath", "setignorefriendlyhits", "setignoresresistance", "setinchargen", "setingredient",
    "setingredientchance", "setinputtext", "setinvestmentgold", "setisautomaticdoor", "setiscontrol", "setisfood", "setishiddendoor",
    ...
    "setspellmagickacost", "setspellmasterylevel", "setspellpcstart", "setspellscripteffectalwaysapplies", "setspelltype", "setstage",
    ...
    "tapcontrol", "tapkey", "this", "toggleactorsai", "togglecreaturemodel", "togglefirstperson", "toggleskillperk", "togglespecialanim", "tolower",
    "tonumber", "tostring", "toupper", "trapupdate", "triggerhitshader", "triggerplayerskilluse", "triggerplayerskillusec", "typeof",
    "uncompletequest", "unequipitem", "unequipitemns", "unequipitemsilent", "unequipme", "unhammerkey", "unlock", "update3d", "updatetextinput",
    "vampirefeed", "vecmag", "vecnorm", "vectorcross", "vectordot", "vectormagnitude", "vectornormalize", "wait", "wakeuppc", "whichservicemenu",
    "yield", "zeromat",
    //-------------------------------
  };
