...
struct Scanner {
  ...
  set<string> function_set = {
    ...
    "equipitem2ns", "equipitemns", "equipitemsilent", "equipme", "essentialdeathreload", "eval", "evaluatepackage",	"eventhandlerexist", "evp", "exp",
    ...
    "tapcontrol", "tapkey", "testexpr", "this", "toggleactorsai", "togglecreaturemodel", "togglefirstperson", "toggleskillperk", "togglespecialanim", "tolower",
